...
const LONG_SURAHS = [TB, window.TADABBUR_ALIMRAN, window.TADABBUR_NISA, window.TADABBUR_MAIDA, window.TADABBUR_ANAM, window.TADABBUR_ARAF, window.TADABBUR_ANFAL, window.TADABBUR_TAWBA, window.TADABBUR_YUNUS, window.TADABBUR_HUD, window.TADABBUR_YUSUF, window.TADABBUR_RAD, window.TADABBUR_IBRAHIM, window.TADABBUR_HIJR, window.TADABBUR_NAHL, window.TADABBUR_ISRA, window.TADABBUR_KAHF, window.TADABBUR_MARYAM, window.TADABBUR_TAHA, window.TADABBUR_ANBIYA, window.TADABBUR_HAJJ, window.TADABBUR_MUMINUN, window.TADABBUR_NUR, window.TADABBUR_FURQAN, window.TADABBUR_SHUARA, window.TADABBUR_NAML, window.TADABBUR_QASAS, window.TADABBUR_ANKABUT, window.TADABBUR_RUM, window.TADABBUR_LUQMAN, window.TADABBUR_SAJDA, window.TADABBUR_AHZAB, window.TADABBUR_SABA, window.TADABBUR_FATIR, window.TADABBUR_YASIN, window.TADABBUR_SAFFAT, window.TADABBUR_SAD, window.TADABBUR_ZUMAR, window.TADABBUR_GHAFIR, window.TADABBUR_FUSSILAT, window.TADABBUR_SHURA, window.TADABBUR_ZUKHRUF, window.TADABBUR_DUKHAN, window.TADABBUR_JATHIYA, window.TADABBUR_AHQAF, window.TADABBUR_MUHAMMAD, window.TADABBUR_FATH, window.TADABBUR_HUJURAT, window.TADABBUR_QAF, window.TADABBUR_DHARIYAT, window.TADABBUR_TUR, window.TADABBUR_NAJM, window.TADABBUR_QAMAR, window.TADABBUR_RAHMAN, window.TADABBUR_WAQIA, window.TADABBUR_HADID, window.TADABBUR_MUJADILA, window.TADABBUR_HASHR, window.TADABBUR_MUMTAHINA, window.TADABBUR_SAFF, window.TADABBUR_JUMUA, window.TADABBUR_MUNAFIQUN, window.TADABBUR_TAGHABUN, window.TADABBUR_TALAQ, window.TADABBUR_TAHRIM, window.TADABBUR_MULK, window.TADABBUR_QALAM, window.TADABBUR_HAQQA, window.TADABBUR_MAARIJ, window.TADABBUR_NUH, window.TADABBUR_JINN, window.TADABBUR_MUZZAMMIL, window.TADABBUR_MUDDATHTHIR, window.TADABBUR_QIYAMA, window.TADABBUR_INSAN, window.TADABBUR_MURSALAT, window.TADABBUR_NABA, window.TADABBUR_NAZIAT, window.TADABBUR_ABASA, window.TADABBUR_TAKWIR, window.TADABBUR_INFITAR, window.TADABBUR_MUTAFFIFIN, window.TADABBUR_INSHIQAQ, window.TADABBUR_BURUJ, window.TADABBUR_TARIQ, window.TADABBUR_ALA, window.TADABBUR_GHASHIYA, window.TADABBUR_FAJR, window.TADABBUR_BALAD, window.TADABBUR_SHAMS, window.TADABBUR_LAYL, window.TADABBUR_DUHA, window.TADABBUR_SHARH, window.TADABBUR_TIN, window.TADABBUR_ALAQ, window.TADABBUR_QADR, window.TADABBUR_BAYYINAH, window.TADABBUR_ZALZALAH, window.TADABBUR_ADIYAT, window.TADABBUR_QARIAH, window.TADABBUR_TAKATHUR, window.TADABBUR_ASR, window.TADABBUR_HUMAZAH, window.TADABBUR_FIL, window.TADABBUR_QURAYSH, window.TADABBUR_MAUN, window.TADABBUR_KAWTHAR, window.TADABBUR_KAFIRUN, window.TADABBUR_NASR, window.TADABBUR_MASAD, window.TADABBUR_IKHLAS, window.TADABBUR_FALAQ, window.TADABBUR_NAS].filter(Boolean)
